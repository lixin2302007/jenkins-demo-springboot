...
public class BookTicketClientHandler extends ChannelInboundHandlerAdapter {
  private User user;
  public BookTicketClientHandler() {
    user=new User();
    user.setName("xwalker");
    user.setPhone("187667*****");
    user.setIdCard("3705231988********");
  }
  /**
   * 链路链接成功
   */
  ...
  public void channelRead(ChannelHandlerContext ctx, Object msg)
    ...
    switch (responseMsg.getCode()) {
      case Code.CODE_SEARCH://收到查询结果
        System.out.println("==========火车【"+responseMsg.getTrain().getNumber()+"】余票查询结果:【"+(responseMsg.isSuccess()?"成功":"失败")+"】=========");
      ...
      case Code.CODE_BOOK://收到订票结果
        System.out.println("==========火车【"+responseMsg.getTrain().getNumber()+"】订票结果:【"+(responseMsg.isSuccess()?"成功":"失败")+"】=========");
        System.out.println(responseMsg.getMsg());
        ...
        System.out.println("乘客信息：【"+ticket.getUser().getName()+"】");
        break;
      default:
