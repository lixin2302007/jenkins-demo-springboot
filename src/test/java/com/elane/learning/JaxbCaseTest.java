...
import com.elane.learning.convert.jaxb.GradeJaxb;
import com.elane.learning.convert.jaxb.StudentJaxb;
...
public class JaxbCaseTest {
  ...
  public void xmlToJava() throws Exception {
    ...
    InputStream in = JaxbCaseTest.class.getResourceAsStream("/student2.xml");
    //将XML数据序列化
